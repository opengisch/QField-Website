...
{{< figure src="1mio_qfield_icon-1.png" alt="" caption="" width="300px" class="d-block mx-auto" >}}
...
### From {{< green text="Switzerland" />}} to the world!🇨🇭
...
{{< figure src="qf-switzerland-5.png" alt="" caption="" >}}

#### **Mapping the {{< green text="world" />}} one field at a time.**
...
{{< figure src="50-countries-qf-3.png" alt="" caption="" >}}
...
{{< figure src="qf-top-countries.png" alt="" caption="" >}}
...
{{< figure src="qf-everywhere-3.png" alt="" caption="" >}}
...
{{< figure src="qf-milestones.png" alt="" caption="" >}}
...
{{< figures-row >}}
{{< figure src="qf-support-1-7.png" alt="Support option 1" caption="" width="137px" href="https://qfield.cloud" >}}
{{< figure src="qf-support-2-5.png" alt="Support option 2" caption="" width="89px" href="https://github.com/sponsors/opengisch" >}}
{{< figure src="qf-support-3-5.png" alt="Support option 3" caption="" width="137px" href="https://www.opengis.ch/#contact" >}}
{{< /figures-row >}}
...
{{< button href="https://qfield.org/support-us" text="💚 SUPPORT US" style="nav" >}}
