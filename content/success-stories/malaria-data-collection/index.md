...
{{< figure src="mosquito1.jpg" alt="land cover parcels digitalized on the ground" caption="" >}}

##### _Three land cover parcels that were digitalized on the ground_

{{< figure src="mosquito2.jpg" alt="information collected" caption="" >}}

##### _Getting back to one parcel: which information was collected_

{{< figure src="mosquito3.jpg" alt="digitalizing new parcel" caption="" >}}

##### _Digitalizing a new parcel and filling the attribute table_

{{< figure src="mosquito4.jpg" alt="field work with QField" caption="" >}}
